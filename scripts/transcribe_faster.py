...
def main():
    ...
    prompt = EN_PROMPT if args.language == "en" else ZH_PROMPT if args.language == "zh" else None
    ...
    print("TRANSCRIBE_LANGUAGE " + json.dumps({"language": getattr(info, "language", args.language)}, ensure_ascii=False), flush=True)
